...
const ForgotPassword = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] p-10 relative z-10 border border-slate-100 dark:border-slate-800">
        {!submitted ? (
          <>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 border border-slate-300 dark:border-slate-700 dark:bg-slate-800 dark:text-slate-200 rounded-lg focus:ring-2 focus:ring-sky-500 focus:border-sky-500 outline-none transition-all placeholder:text-slate-400"
          ...
          <div className="text-center py-6">
            ...
            <h2 className="text-2xl font-bold text-slate-800 dark:text-slate-100 mb-2">Check your mail</h2>
            <p className="text-slate-500 dark:text-slate-400 text-sm mb-8">We have sent a password recover instructions to your email.</p>
            <button
        ...
        <div className="mt-8">
          <Link
            to="/login"
            className="flex items-center justify-center font-semibold text-slate-500 dark:text-slate-400 hover:text-slate-700 dark:text-slate-300 transition-colors group"
          >
