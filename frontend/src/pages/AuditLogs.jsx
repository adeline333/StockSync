...
import { Search, LayoutDashboard, ShieldCheck, FileText, Settings, Download,
      ...
      <aside className="w-64 bg-slate-900 flex flex-col fixed h-full z-20">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1">
          ...
          <div className="pt-4 border-t border-slate-800 mt-4">
            ...
            <Link to="/admin/audit" className="flex items-center px-4 py-3 rounded-xl text-sm font-medium bg-slate-800 text-white relative overflow-hidden">
