...
import { LayoutDashboard, TrendingUp, Activity, BatteryWarning, BarChart2,
    ...
    <div className="min-h-screen bg-slate-50 flex font-sans">
      <aside className="w-64 bg-slate-900 flex flex-col fixed h-full z-20">
        ...
        <nav className="flex-1 px-4 py-6 space-y-1">
          ...
          <Link to="/analytics/forecasting" className="flex items-center px-4 py-3 rounded-xl text-sm font-medium bg-slate-800 text-white relative overflow-hidden mt-1">
          ...
          <Link to="/inventory/reorder" className="flex items-center px-4 py-3 rounded-xl text-sm font-medium text-slate-400 hover:bg-slate-800 hover:text-white transition-colors mt-1">
            <ShoppingCart className="w-5 h-5 mr-3" /> Reorder List
          </Link>
        </nav>
      </aside>
