...
const NAV_CONFIG = {
  admin: [
    ...
    { label: 'Transfers', icon: ListChecks, to: '/transfers/approvals' },
  ...
  manager: [
    ...
    { label: 'Transfers', icon: ArrowRightLeft, to: '/transfers/new' },
    { label: 'Approvals', icon: ListChecks, to: '/transfers/approvals' },
    { label: 'Locations', icon: MapPin, to: '/locations' },
    { label: 'Reconciliation', icon: ArrowRightLeft, to: '/reconciliation' },
    { label: 'Analytics', icon: BarChart2, to: '/analytics/forecasting' },
